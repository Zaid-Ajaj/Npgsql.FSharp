...
This comes in two flavors, available through _mutually exclusive_ namespaces:
...
```fs
// Aquire your connection string somehow,
// for example using environment variables, a hardcoded value or using the builder API
